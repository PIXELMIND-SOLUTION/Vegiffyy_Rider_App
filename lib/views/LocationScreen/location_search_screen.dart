...
Future<void> _loadUserData() async {
  ...
  try {
    // Get userId directly from shared preferences (SessionManager)
    final storedUserId = await SessionManager.getUserId();
    print('Stored userId from SessionManager: $storedUserId');
    ...
    _showSnackBar("Failed to load user ID: $e", isError: true);
  }
}
